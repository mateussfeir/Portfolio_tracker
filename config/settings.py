...
SECRET_KEY = "django-insecure-utb%uv^d=xfl3vnazf2og2+n*%t5caihw=@(kn9mh8%2igc&0e"
...
MIDDLEWARE = [
    ...
    "portfolio.middleware.DemoReadOnlyMiddleware",
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "portfolio.context_processors.demo_flags",
            ],
        },
    },
]
